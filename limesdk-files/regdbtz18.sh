...
# develop environment patch for openwrt18
# src https://github.com/libremesh/lime-sdk/blob/develop/snippets/regdbtz.sh
# extra ref https://dev.qmp.cat/projects/qmp-cooker/repository/revisions/master/entry/snippets/regdbus.sh
