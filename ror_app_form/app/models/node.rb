...
class Node
  ...
  attr_accessor :device, :node_name, :wifi_channel, :ip4_cidr, :vars
  validates :device, :node_name, :wifi_channel, :ip4_cidr, presence: true
  ...
  def validate_ip_address
    ...
    #unless IPAddress.valid_ipv4_subnet? addr
      errors.add(:ip4_cidr, 'IP address invalid. Example: 10.0.0.1/27')
    end
  end
end
